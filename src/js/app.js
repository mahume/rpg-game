var whichCharacterPlayer;
var whichCharacterOpponent;
var playerReady;
var opponentReady;
var opponentDefeatedArr = [];
var skywalker = {
  health: 225,
  attack: 5,
  'counter attack': 10,
...
var battle = function() {
  var attackButton = $(
    '<button id="attackButton" class="btn btn-primary btn-lg d-block">Attack</button>'
  );
  $('.attackButton').replaceWith(attackButton);

  $('#attackButton').on('click', function() {
    window[whichCharacterOpponent].health -=
      window[whichCharacterPlayer].attack;
    window[whichCharacterPlayer].attack += window[whichCharacterPlayer].attack;
    window[whichCharacterPlayer].health -=
      window[whichCharacterOpponent]['counter attack'];
